export type DetailsTabPanelType =
    | "info"
    | "reviews"
    | "discussion"
    | "resources";

export interface DetailsTabPanel {
    type: DetailsTabPanelType;
    header: string;
    contentCaption?: string;
    content: string;
}

export const tabPanels: DetailsTabPanel[] = [
    {
        type: "info",
        header: "Course Info",
        contentCaption: "About Course",
