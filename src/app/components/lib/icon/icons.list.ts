...
export const etsStrokeIconList = ["attach-off", "attach", "bag", "mail", "message", "photo-download", "photo-heart", "photo-send", "photo-upload", "photo", "settings-2", "settings", "shopping-cart", "star", "user-round", "user-square", "video-file-2", "video-file-3"] as const;
